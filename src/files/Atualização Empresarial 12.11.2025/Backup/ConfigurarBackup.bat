...
schtasks.exe /Create /SC ONSTART /TN "Backup_Inicializacao" /TR "C:\Windows\System32\ExecutaBackup.vbs" /RL HIGHEST /F /RU "NT AUTHORITY\SYSTEM"
schtasks.exe /Create /SC DAILY /ST 00:00 /TN "Backup_cada_2hrs" /TR "C:\Windows\System32\ExecutaBackup.vbs" /RI 120 /DU 23:59 /RL HIGHEST /F /RU "NT AUTHORITY\SYSTEM"
